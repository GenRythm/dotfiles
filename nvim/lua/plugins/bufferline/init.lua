...
Keymap.g({
    { 'n', '<Space><Space>', '<Cmd>BufferLinePick<CR>', { noremap = true, silent = true } },
    ...
    { 'n', '<Space>4', '<Cmd>BufferLineGoToBuffer 4<CR>', { noremap = true, silent = true } },
    { 'n', '<Space>5', '<Cmd>BufferLineGoToBuffer 5<CR>', { noremap = true, silent = true } },
    { 'n', '<Space>6', '<Cmd>BufferLineGoToBuffer 6<CR>', { noremap = true, silent = true } },
